...
export const CLOUD_VIEWS = [
  { id: 'field' as const, label: 'Field', src: '/mock/iot-field.png?v=en' },
  { id: 'chart' as const, label: 'Chart', src: '/mock/iot-chart.png?v=en' },
  { id: 'model' as const, label: 'Model', src: '/mock/iot-model.png?v=en' },
] as const;
